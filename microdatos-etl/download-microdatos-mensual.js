...
// Model normalization rules (keep in sync with download-microdatos.js)
const BRAND_EXACT = {
...
const BRAND_PREFIX = {
  ...
  YAMAHA:  [['MTN690', 'MT-07'], ['MTT890', 'Tracer 9 GT '], ['MWS125', 'TRICITY 125'], ['XTZ690', 'XTZ 700 Tenere'], ['MTN125', 'MT-125'], ['MTM125', 'MT-125'], ['XP560', 'TMAX 560'], ['CZD300', 'XMAX 300'], ['YZF125', 'R125'], ['MTN890', 'MT-09'], ['MTT690', 'MT-07'], ['MTM690', 'XSR700'], ['YZF890', 'YZF-R9'], ['MTN1000', 'MT-10'], ['MTM890', 'XSR-900'], ['YZF320', 'YZF-R3'], ['MXT890', 'NIKEN GT']],
...
function writeAggregates(year, month, data) {
  ...
  console.log(`  Written aggregates: ${year}/${month} (${rows.length} brand-model combinations)`);
}

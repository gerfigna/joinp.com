...
- [x] 1.2 Crear tabla `BRAND_PREFIX` en `microdatos-etl/download-microdatos.js` con las reglas de prefijo de SYM (migrada desde inline), YAMAHA (MTT690, MTT890, MWS125), BMW, BRIXTON, DUCATI, HONDA, KTM y KYMCO

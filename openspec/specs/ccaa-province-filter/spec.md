# CCAA–Province Filter

## Purpose

Cascading Comunidad Autónoma → Provincia filter in the matriculaciones dashboard. Selecting a community narrows the province dropdown to only the provinces within that community.
